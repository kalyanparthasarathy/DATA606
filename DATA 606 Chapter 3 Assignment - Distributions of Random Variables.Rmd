---
title: "DATA 606 Chapter 3 Assignment - Distributions of Random Variables"
...
# N(µ =0,? = 1) is found in each region? Be sure to draw a graph.
...
# Leo: Mean(μ)=4313, sd(σ)=583, x=4948 so Z = (x-μ)/σ = (4948-4313)/583 = 1.0891
...
# Mary: Mean(μ)=5261, sd(σ)=807, x=5513 so Z = (x-μ)/σ = (5513-5261)/807 = 0.3123
